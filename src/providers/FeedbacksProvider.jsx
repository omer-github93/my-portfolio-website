...
export const FeedbacksProvider = ({children}) => {
    ...
    const [displayingDetails, setDisplayingDetails] = useState(null)
    ...
    // PROJECT DETAILS...
    const displayProjectDetails = (title, subtitle, info, text, details, tags, type) => {
    ...
    const hideProjectDetails = () => {
        setDisplayingDetails(null)
    }

    // OTHER METHODS...
    const isModalOpen = () => {
        return isShowingSpinner() || displayingYoutubeVideo || displayingGallery || displayingDetails || pendingConfirmation
    }
