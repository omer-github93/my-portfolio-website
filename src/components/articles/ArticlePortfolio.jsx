            ...
            <Row className={`gx-4 gy-lg-4 gx-lg-5`}>
                <Categorizable items={parsedItems}
                    ...
                    <Expandable items={categoryFilterResult}
                        ...
                        {expandableFilterResult.length > 0 ? (
                            ...
                            <Col className={`col-12 text-center mt-5 mb-5 opacity-50`}>
                                <i className={`fa-solid fa-folder-open mb-3 d-block`} style={{ fontSize: '3rem' }}/>
                                <h4 className={`fw-bold`}>{parsedData.empty_results || "No projects found yet!"}</h4>
                            </Col>
                        )}
                    </Expandable>
                </Categorizable>
