...
export const useParser = () => {
    ...
    const parseArticleData = (articleData, supportedFormats) => {
        ...
        return {
            ...
            empty_results: getTranslation(articleData.locales, 'empty_results', true),
    ...
    const parseArticleItems = (rawItems, options) => {
        ...
        return rawItems.map((item, key) => {
            ...
            parsedItem.type = utils.parseJsonText(getTranslation(locales, "type", true))
            ...
            parsedItem.details = utils.parseJsonText(getTranslation(locales, "details", true))
