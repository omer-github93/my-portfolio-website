...
1. Clone the repo:
```
git clone https://github.com/omer-github93/my-portfolio-website
```
...
Place your translations for **static texts** in `public/data/translations.json`. This file serves as a central hub for all your global localization needs, making your translations accessible via the helper method `getString`:
...
In simple terms, if you consider GitHub hosting the GitHub Pages site for this repo at the URL `https://omer-github93.github.io/my-portfolio-website/`, the correct base directory to set is `/my-portfolio-website/`.
...
This portfolio was personalized and is maintained by **[Omer Tariq](https://github.com/omer-github93)**.
